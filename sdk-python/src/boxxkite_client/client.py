"""Sync and async clients for a hosted boxxkite control-plane.

Thin wrapper over the same v1 HTTP API the `boxxkite` CLI itself calls
...
class BoxxkiteClient:
    ...
    def __enter__(self) -> BoxxkiteClient:
        return self
        ...
        while True:
            try:
                ...
                if _should_retry(self._retry, method, attempt, None):
                    ...
                    attempt += 1
                    continue
                raise BoxxkiteConnectionError(str(exc)) from exc
    ...
    def request_password_reset(self, email: str) -> dict:
        ...
        control-plane (BOXXKITE_PASSWORD_RESET_ENABLED); raises
        BoxxkiteApiError(404, "feature_disabled") if the deployment hasn't
    ...
    def confirm_password_reset(self, token: str, new_password: str) -> dict:
        ...
        refresh tokens are enabled server-side. Raises BoxxkiteApiError(400,
    ...
    def verify_email(self, token: str) -> dict:
        ...
        marks the account's email verified. Raises BoxxkiteApiError(400,
        "invalid_or_expired_token") for an unknown, already-used, or
        expired token.
        """
    ...
    def refresh_token(self, refresh_token: str) -> dict:
        ...
        BoxxkiteApiError(401, "invalid_refresh_token") if the token is
        ...
        *,
        ...
        Args:
            ...
            gpu_count: Opt-in, experimental (docs/GPU-SUPPORT-SCOPING.md) --
                ...
                BOXXKITE_GPU_ENABLED set and a GPU-equipped node pool with a
    ...
    def create_image(
        ...
        *,
        ...
        Args:
            ...
            base: Base image to build from -- one of "boxxkite-default",
                "boxxkite-minimal", "boxxkite-node", "boxxkite-go",
                "boxxkite-nextjs", "boxxkite-rust". Defaults to
                "boxxkite-default". "boxxkite-node" drops Python entirely (no
                python_packages installable, only apt_packages/npm_packages).
                "boxxkite-go" and "boxxkite-rust" both drop Python and Node
                entirely (no python_packages or npm_packages installable,
                only apt_packages). "boxxkite-nextjs" is the same Node-only
                runtime as "boxxkite-node" plus a pre-installed Next.js App
                Router starter vendored at /opt/nextjs-template (same
                python_packages restriction as "boxxkite-node").
            ...
            npm_packages: Exact-version-pinned npm packages ("name==version",
                ...
                image. Not supported on base="boxxkite-go" or
                base="boxxkite-rust".
        """
        body: dict[str, Any] = {}
        if label:
    ...
    def create_mcp_connection(self, *, label: str, catalog_id: str) -> dict:
        ...
        Args:
            ...
            catalog_id: Which curated catalog entry to grant -- one of
                ...
                boxxkite's own reviewed allowlist; never a caller-supplied
                hostname.
    ...
    def desktop_takeover(self, session_id: str) -> websockets.sync.client.ClientConnection:
        ...
        deployment has not set `BOXXKITE_DESKTOP_ENABLED`.
...
class AsyncBoxxkiteClient:
    """Async counterpart of BoxxkiteClient, same method shapes throughout."""
    ...
    async def __aenter__(self) -> AsyncBoxxkiteClient:
        return self
    ...
    async def request_password_reset(self, email: str) -> dict:
        ...
        `BoxxkiteClient.request_password_reset`. See that docstring."""
    ...
    async def confirm_password_reset(self, token: str, new_password: str) -> dict:
        ...
        `BoxxkiteClient.confirm_password_reset`. See that docstring."""
    ...
    async def verify_email(self, token: str) -> dict:
        ...
        `BoxxkiteClient.verify_email`. See that docstring."""
    ...
    async def resend_verification(self, access_token: str) -> dict:
        ...
        `BoxxkiteClient.resend_verification`. See that docstring for why the
    ...
    async def refresh_token(self, refresh_token: str) -> dict:
        ...
        `BoxxkiteClient.refresh_token`. See that docstring."""
    ...
    async def logout(self, refresh_token: str) -> None:
        ...
        `BoxxkiteClient.logout`. See that docstring."""
    ...
    async def create_volume(self, *, label: str | None = None, size_gb: float) -> dict:
        ...
        `BoxxkiteClient.create_volume`. See that docstring."""
        body: dict[str, Any] = {"size_gb": size_gb}
        if label:
            body["label"] = label
    ...
    async def create_webhook(
        ...
        *,
        ...
        `BoxxkiteClient.create_webhook`. See that docstring."""
        body: dict[str, Any] = {"url": url, "event_types": event_types}
        if description is not None:
            body["description"] = description
    ...
    async def list_webhook_deliveries(
        ...
        `BoxxkiteClient.list_webhook_deliveries`. See that docstring."""
        params: dict[str, Any] = {}
        if limit is not None:
            params["limit"] = limit
        if offset is not None:
    ...
    async def create_mcp_connection(self, *, label: str, catalog_id: str) -> dict:
        ...
        `BoxxkiteClient.create_mcp_connection`. See that docstring."""
        return await self._request(
            "POST", "/v1/mcp-connections", json={"label": label, "catalog_id": catalog_id}
        )
    ...
    async def create_secret(
        ...
        *,
        ...
        `BoxxkiteClient.create_secret`. See that docstring."""
        body: dict[str, Any] = {"name": name, "value": value, "allowed_hosts": allowed_hosts}
        if trust_tier is not None:
            body["trust_tier"] = trust_tier
    ...
    async def start_process(
        ...
        *,
        ...
        `BoxxkiteClient.start_process`. See that docstring."""
        body: dict[str, Any] = {"command": command, "max_runtime_seconds": max_runtime_seconds}
        if description is not None:
            body["description"] = description
    ...
    async def get_process_output(self, session_id: str, process_id: str, *, since_offset: int = 0) -> dict:
        """GET /v1/sandboxes/{session_id}/processes/{process_id}/output --
        async counterpart of `BoxxkiteClient.get_process_output`."""
        params: dict[str, Any] = {"since_offset": since_offset}
        return await self._request(
            "GET", f"/v1/sandboxes/{session_id}/processes/{process_id}/output", params=params
        )
    ...
    async def stream_process_output(
        ...
        counterpart of `BoxxkiteClient.stream_process_output`. See that
    ...
    async def watch(self, session_id: str) -> AsyncIterator[dict]:
        ...
        `BoxxkiteClient.watch`. See that docstring for the SSE contract."""
    ...
    async def takeover(self, session_id: str) -> Any:
        ...
        `BoxxkiteClient.takeover`. See that docstring for the raw-byte
    ...
    async def desktop_takeover(self, session_id: str) -> Any:
        ...
        `BoxxkiteClient.desktop_takeover`. See that docstring for the RBAC
    ...
    async def create_preview_url(self, session_id: str, port: int, *, ttl_seconds: int | None = None) -> dict:
        ...
        of `BoxxkiteClient.create_preview_url`. See that docstring."""
        body: dict[str, Any] = {}
        if ttl_seconds is not None:
            body["ttl_seconds"] = ttl_seconds
    ...
    async def revoke_preview_url(self, session_id: str, port: int, token_id: str) -> dict:
        ...
        counterpart of `BoxxkiteClient.revoke_preview_url`. See that
        docstring."""
        return await self._request(
            "POST", f"/v1/sandboxes/{session_id}/preview/{port}/revoke", json={"token_id": token_id}
        )
