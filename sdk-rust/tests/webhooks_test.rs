...
use boxxkite_client::{CreateWebhookOptions, ListWebhookDeliveriesOptions, WebhookEventType};
use serde_json::json;
...
async fn create_webhook_sends_url_and_event_types_and_returns_secret_once() {
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(ResponseTemplate::new(201).set_body_json(json!({
            ...
            "event_types": ["sandbox.created", "sandbox.destroyed"],
            "description": "Slack notifier", "is_active": true, "payload_format": "boxxkite_v1",
...
async fn create_webhook_accepts_audit_log_entry_event_type() {
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(ResponseTemplate::new(201).set_body_json(json!({
            ...
            "event_types": ["audit_log.entry"],
            "description": null, "is_active": true, "payload_format": "boxxkite_v1",
            "created_at": "2026-01-01T00:00:00Z", "last_triggered_at": null,
            "secret": "whsec_def456"
        })))
        .mount(&server)
