...
impl CreateImageOptions {
    ...
    /// Defaults to [`ImageBase::BoxxkiteDefault`] server-side when omitted.
    ...
    /// `"polars==1.9.0"`. Not supported on [`ImageBase::BoxxkiteNode`] or
    /// [`ImageBase::BoxxkiteGo`].
    ...
    /// `"typescript==5.6.0"`. Not supported on [`ImageBase::BoxxkiteGo`].
...
impl Client {
    ...
    pub async fn create_image(&self, options: CreateImageOptions) -> Result<Image, BoxxkiteError> {
    ...
    pub async fn get_image(&self, image_id: &str) -> Result<Image, BoxxkiteError> {
    ...
    pub async fn list_images(&self) -> Result<Vec<Image>, BoxxkiteError> {
    ...
    pub async fn delete_image(&self, image_id: &str) -> Result<(), BoxxkiteError> {
