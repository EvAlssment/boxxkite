...
404s every /node-interpreter/* call unless BOXXKITE_NODE_INTERPRETER_ENABLED
...
def create_node_interpreter_tool(
    ...
    boxxkite.tools.adapters.to_langchain_tools, kept for existing callers
    that expect a LangChain BaseTool directly. Requires the `langchain`
    extra (`pip install boxxkite-sandbox[langchain]`).
