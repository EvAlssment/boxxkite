...
`src/boxxkite/manager.py`'s `_identity_labels_and_annotations` is the only
...
granted secrets' allowed hosts. `src/boxxkite/manager.py` creates this
...
# separately-packaged src/boxxkite core, not the sidecar or control-plane
    ...
    *,
    ...
    return client.V1NetworkPolicy(
        metadata=client.V1ObjectMeta(
            ...
            labels={
                "app": "sandbox",
                "sandbox.boxxkite.dev/secrets-egress": "true",
            },
        ),
