"""`boxxkite config set-key` / `set-url` / `show` — hosted-mode configuration.
...
def set_url(
    base_url: str = typer.Argument(..., help="Base URL of a hosted boxxkite control-plane, e.g. https://api.example.com."),
) -> None:
