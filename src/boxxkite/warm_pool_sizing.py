...
Off by default (BOXXKITE_ADAPTIVE_WARM_POOL_ENABLED=false): WarmPoolManager
...
BOXXKITE_ADAPTIVE_WARM_POOL_ENABLED_ENV = "BOXXKITE_ADAPTIVE_WARM_POOL_ENABLED"
BOXXKITE_ADAPTIVE_WARM_POOL_WINDOW_SECONDS_ENV = "BOXXKITE_ADAPTIVE_WARM_POOL_WINDOW_SECONDS"
BOXXKITE_ADAPTIVE_WARM_POOL_COVERAGE_SECONDS_ENV = "BOXXKITE_ADAPTIVE_WARM_POOL_COVERAGE_SECONDS"
...
def adaptive_warm_pool_enabled() -> bool:
    ...
    second time."""
    return _env_flag(BOXXKITE_ADAPTIVE_WARM_POOL_ENABLED_ENV, "false")
...
def resolve_warm_pool_size_targets(
    ...
    BOXXKITE_ADAPTIVE_WARM_POOL_ENABLED is off -- the default -- so callers
