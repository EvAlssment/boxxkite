"""
boxxkite — a self-hostable, Kubernetes-native sandbox for agent code execution.
...
- Tool surface: bash_tool, file_create, view, str_replace, present_files
  (LangChain tools, in `boxxkite.tools`)
...
- `boxxkite.audit.AuditSink` — mirror file writes into your own system of record
- `boxxkite.session_store.SessionMetadataStore` — reconstruct session ownership
