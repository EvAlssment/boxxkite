...
SANDBOX_SIZE_LABEL = "sandbox.boxxkite.dev/size"
...
BOXXKITE_KATA_RUNTIME_CLASS_ENABLED_ENV = "BOXXKITE_KATA_RUNTIME_CLASS_ENABLED"
...
def kata_runtime_class_enabled() -> bool:
    return _env_flag(BOXXKITE_KATA_RUNTIME_CLASS_ENABLED_ENV, "false")
...
BOXXKITE_FAST_CLAIM_ENABLED_ENV = "BOXXKITE_FAST_CLAIM_ENABLED"


def fast_claim_enabled() -> bool:
    return _env_flag(BOXXKITE_FAST_CLAIM_ENABLED_ENV, "false")
...
# object.
BOXXKITE_GPU_ENABLED_ENV = "BOXXKITE_GPU_ENABLED"
GPU_RESOURCE_NAME_ENV = "BOXXKITE_GPU_RESOURCE_NAME"
...
BOXXKITE_MAX_GPU_COUNT_PER_SESSION_ENV = "BOXXKITE_MAX_GPU_COUNT_PER_SESSION"
DEFAULT_MAX_GPU_COUNT_PER_SESSION = "1"


def gpu_enabled() -> bool:
    return _env_flag(BOXXKITE_GPU_ENABLED_ENV, "false")
...
def max_gpu_count_per_session() -> int:
    return int(
        _env_quantity(BOXXKITE_MAX_GPU_COUNT_PER_SESSION_ENV, DEFAULT_MAX_GPU_COUNT_PER_SESSION)
    )
...
# NOT a pause/resume mechanism; see src/boxxkite/checkpoint_backend.py's
...
# applied, flag off).
BOXXKITE_FULL_STATE_SNAPSHOT_ENABLED_ENV = "BOXXKITE_FULL_STATE_SNAPSHOT_ENABLED"


def full_state_snapshot_enabled() -> bool:
    return _env_flag(BOXXKITE_FULL_STATE_SNAPSHOT_ENABLED_ENV, "false")
