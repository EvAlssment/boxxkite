...
class SidecarProxyMixin:
    ...
    async def node_interpreter_exec(
        ...
        BOXXKITE_NODE_INTERPRETER_ENABLED set; otherwise the sidecar 404s
    ...
    async def lsp_start(self, session_id: str, language: str) -> dict:
        ...
        sidecar to have BOXXKITE_LSP_ENABLED set; otherwise the sidecar
        404s.
    ...
    async def browser_navigate(
        ...
        BOXXKITE_BROWSER_ENABLED set; otherwise the sidecar 404s.
    ...
    async def browser_exec(
        ...
        Requires BOXXKITE_BROWSER_ENABLED; otherwise the sidecar 404s.
    ...
    async def browser_close(self, session_id: str) -> dict:
        ...
        one. Requires BOXXKITE_BROWSER_ENABLED; otherwise the sidecar 404s.
    ...
    async def pty_exec(
        ...
        404s unless the sidecar has `BOXXKITE_AGENT_PTY_ENABLED=true` set --
