...
for this repository (Security tab → Report a vulnerability) — the same
private channel documented in [SECURITY.md](SECURITY.md). If that path isn't
available to you, open a regular issue that says only "code of conduct
issue, please contact me privately" with no further detail, and a maintainer
will reach out through a private channel.
