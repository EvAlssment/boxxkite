...
code is touched by this package -- it composes boxxkite_client.BoxxkiteClient
...
logger = logging.getLogger("boxxkite_handoff")

DEFAULT_LIFETIME_MINUTES = 120
CREDENTIAL_FILE_TEMPLATE = "/tmp/.boxxkite-handoff-credential-{suffix}"
...
def _push_session_files(client: BoxxkiteClient, sandbox_id: str, session: LocatedSession) -> None:
...
def _shell_quote(value: str) -> str:
    ...
    quotes a boxxkite-handoff-generated path, never arbitrary user input."""
