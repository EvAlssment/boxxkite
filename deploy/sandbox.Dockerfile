...
# Sandbox Container
# Pre-installed with comprehensive data science and file processing libraries
# Network can be disabled at runtime, so ALL packages must be pre-installed here
#
# SECURITY NOTES:
